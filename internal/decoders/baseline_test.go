...
func decodeFor(t *testing.T, data []byte, cpu CPU) *Instruction {
	...
	decoder := FindDecoder(opcode, cpu)
	if decoder == nil {
...
func TestDecodeLINK(t *testing.T) {
	...
	if d := FindDecoder(0x480D, M68000); sameDecoder(d, decodeLINKLong) {
...
func TestDecodeEXTB(t *testing.T) {
	...
	if d := FindDecoder(0x49C1, M68000); sameDecoder(d, decodeEXTB) {
...
func TestDecodeCHK(t *testing.T) {
	...
	if d := FindDecoder(0x4501, M68000); d != nil {
...
func TestDecodeTRAPcc(t *testing.T) {
	...
	if d := FindDecoder(0x51FC, M68000); sameDecoder(d, decodeTRAPcc) {
